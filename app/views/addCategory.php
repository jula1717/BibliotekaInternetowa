...
<div id ="formContainer">
    <form action="<?php echo URLROOT."/categories/categoryFormHandler/dodanie"?>" method="post">
        ...
        <input type="text" <?php if(isset($_SESSION['emptyField'])||isset($_SESSION['errorInvalidData']))echo "class='error'";?> id="category" name="category" placeholder="Nazwa kategorii" pattern="^[[A-Za-zżźćńółęąśŻŹĆĄŚĘŁÓŃ]]+((( |, |-)[[A-Za-zżźćńółęąśŻŹĆĄŚĘŁÓŃ]]+){0,255})" minlength="3" maxlength="255" required>
