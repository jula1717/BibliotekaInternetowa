...
<body>
    ...
    if (isset($_SESSION['savedData'])) {
        echo '<div id="container"><div id="info">';
        echo $_SESSION['savedData'];
    ...
    <div id="formcontainer" class="wfc">
        ...
        <form action="<?php echo URLROOT . '/readerProfile/FormHandler' ?>" method="post">
            ...
            ?>
            <br>
            <input type="tel" <?php if (isset($_SESSION['errorIncompleteRegisterData']) || isset($_SESSION['errorDataAlreadyExists'])) echo "class='error'"; ?> id="workerAdd" name="phone" pattern="[0-9]{9}" placeholder="Telefon" value=<?php echo $_SESSION['userData']->telefon; ?> minlength="9" maxlength="9" required>
            ...
            ?>
            <br>
            <input type="password" <?php if (isset($_SESSION['errorIncompleteLoginData']) || isset($_SESSION['errorInvalidPassword']) || isset($_SESSION['errorWrongPasswordSize'])) echo "class='error'"; ?> id="password" name="oldPassword" placeholder="stare hasło" minlength="8" maxlength="255" required>
            <i class="icon-search help" title="Wprowadź hasło (minimum 8 znaków)."></i>
            <br>
            <input type="password" <?php if (isset($_SESSION['errorIncompleteLoginData']) || isset($_SESSION['errorInvalidPassword']) || isset($_SESSION['errorWrongPasswordSize'])) echo "class='error'"; ?> id="password" name="newPassword" placeholder="nowe hasło" minlength="8" maxlength="255" required>
