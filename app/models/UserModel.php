...
class UserModel
{
    ...
    public function changeUser($nowyEmail, $nowyTelefon, $userId, $newPassword = null)
    {
        if ($newPassword == null)
            $query = 'UPDATE "Uzytkownicy" SET email = :email, telefon=:telefon WHERE id_uzytkownika=:id_uzytkownika;';
        else
            $query = 'UPDATE "Uzytkownicy" SET email = :email, telefon=:telefon, haslo=:haslo WHERE id_uzytkownika=:id_uzytkownika;';
